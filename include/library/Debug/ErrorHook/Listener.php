...
require_once sprintf("%s/Catcher.php", __DIR__);
require_once sprintf("%s/INotifier.php", __DIR__);
require_once sprintf("%s/RemoveDupsWrapper.php", __DIR__);
require_once sprintf("%s/RssNotifier.php", __DIR__);
